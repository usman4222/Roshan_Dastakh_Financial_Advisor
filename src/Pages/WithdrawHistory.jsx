...
const TABLE_HEAD = ["Requested ", "New Balance", "Old Balance", "Request Date", "Approval Date"];
...
const WithdrawHistory = () => {
    ...
    const fetchUserData = async () => {
        ...
        try {
            ...
            const taxTransactions = responseData.data.transactions.filter(transaction => transaction.type === "Withdraw");
